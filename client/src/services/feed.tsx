...
export async function fetchFeed() {
    try {
        ...
        if (!res.ok) {
            ...
            return { failure: true, error: 'Ocorreu um erro ao buscar os feeds', status: res.status }
        }
        ...
        /// Lembrar de fazer alguma pagina de erro
        alert("Houve um erro ao carregar os feeds. Tente novamente ou contacte um administrador!");
        console.error(err);
    }
}
...
export async function postFeed(content: String) {
    try {
        ...
        if (!res.ok) {
            ...
            return { failure: true, error: 'Ocorreu um erro ao fazer a publicação', status: res.status }
        }
        ...
        /// Lembrar de fazer alguma pagina de erro
        alert("Houve um erro ao enviar a publicação. Tente novamente ou contacte um administrador!");
        console.error(err);
    }
}
